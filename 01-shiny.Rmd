...
Note also that the reactivity diagram for `cols_group` indicates that, we use an observer function to update this input. 
...
Although this is one place I strive for redundancy, I am careful to validate using the same values: `agg_function_choices`.
