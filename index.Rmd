...
An example app is created for each framework:
 ...
 - create an aggregated data-frame from the input, using the specification.
   - show aggregated data-frame as a table.
   
The audience I have in mind are folks who know how to develop a basic Shiny app, and wish to extend their knowledge to Dash (Python) or Observable (JavaScript). I will assume you have:
